                         ...
                         <div class="col-md-auto">
                           ...
                           <?php
                                 ...
                                 switch (strtolower($waktu)) {
                                    case 'masuk':
                                       $labelAbsen = 'Absen Masuk';
                                       $btnColor = 'success';
                                       break;
                                    case 'pulang':
                                       $labelAbsen = 'Absen Pulang';
                                       $btnColor = 'warning';
                                       break;
                                    case 'izin':
                                       $labelAbsen = 'Absen Izin';
                                       $btnColor = 'info';
                                       break;
                                 }
                              ?>
                              ...
                              <div class="col-md-auto">
                                 <div class="dropdown">
                                    <button class="btn btn-<?= $btnColor ?> dropdown-toggle px-4 py-2" type="button" id="dropdownAbsen" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                       <i class="material-icons mr-1" style="vertical-align: middle;">event</i>
                                       <?= $labelAbsen ?>
                                    </button>
                                    <div class="dropdown-menu shadow-sm border-0 rounded-lg animate__animated animate__fadeIn" aria-labelledby="dropdownAbsen">
