...
public function absenMasuk(string $id, $date, $time, $idKelas = '', $lat = null, $lng = null)
{
   $this->save([
      'id_siswa'     => $id,
      'id_kelas'     => $idKelas,
   ...
   public function absenKeluar(string $id, $time, $lat = null, $lng = null)
{
   $this->update($id, [
      'jam_keluar' => $time,
      'latitude'   => $lat,
...
public function absenIzin(string $idSiswa, $tanggal, $jam, $idKelas, $lat = null, $lng = null)
{
   return $this->insert([
      'id_siswa'     => $idSiswa,
      'id_kelas'     => $idKelas,
